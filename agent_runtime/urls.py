...
urlpatterns = [
    ...
    path("account/memory/save/", views.account_memory_save, name="account_memory_save"),
    path("account/memory-export/", views.account_memory_export, name="account_memory_export"),
    path("account/memory/<uuid:memory_id>/delete/", views.account_memory_delete, name="account_memory_delete"),
